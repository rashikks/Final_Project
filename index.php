...
$uname=$_POST['uname'];
$upass=$_POST['upass'];
$q=mysql_query("select * from customer where uname='$uname' and upass='$upass'")or die(mysql_error());
$n=mysql_num_rows($q);
if($n>0)
{
...
$_SESSION['uplace']=$r['uplace'];

echo "<script type='text/javascript'>alert('user login successful');</script>";
echo '<meta http-equiv="refresh" content="0;url=view_syllabus.php">';
}
else
{
